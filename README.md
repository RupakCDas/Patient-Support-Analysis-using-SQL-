...
```
[part_1_result.csv](https://github.com/user-attachments/files/26511087/part_1_result.csv)
...
FROM null_call;
```
[part_2_result.csv](https://github.com/user-attachments/files/26511176/part_2_result.csv)
...
[part_3_result.csv](https://github.com/user-attachments/files/26511213/part_3_result.csv)
...
ORDER BY yr, mth;
```
[part_4_result.csv](https://github.com/user-attachments/files/26511217/part_4_result.csv)
...
```
[part_5_result.csv](https://github.com/user-attachments/files/26511237/part_5_result.csv)
...
```
[part_6_result.csv](https://github.com/user-attachments/files/26511242/part_6_result.csv)
